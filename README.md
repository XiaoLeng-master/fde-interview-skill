...
| 模式 | 你会得到什么 | 示例入口 |
| --- | --- | --- |
| 🧭 目标岗位尽调 | 判断目标岗位是真 FDE、早期 FDE、项目交付、高级外包还是实施售后，并生成面试核验问题 | “结合这份公司资料和 JD，判断岗位真实模式” |
...
```text
结合这份 JD、公司产品和公开资料，判断它是真 FDE、早期建设型 FDE、项目交付还是高级外包，并给我面试核验问题。
```
